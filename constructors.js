...
Car.prototype
  ...
  /*
    Here we have a constructor function named Movie that takes in 3 parameters:
      name (a string), genre (a string), and rating (a number withing 1-100 that has been averaged out from 
  ...
  */
  ...
  // Once the User constructor function is created, write a prototype method for the User function. Name 
  //this method addSavedPost. It should take in three parameters: id (a number), title (a string) and 
...
User.prototype.addSavedPost = function(id, title, rating){
  ...
  // one number parameter representing the post id. Use this id to find and remove the matching object 
  ...
  // will take in two number parameters. The first will be an id (a number) and the second will be the new 
  //rating (a number). Use the id to find the matching object in the savedPosts array. Once you find 
  //the matching object, update it's rating score with the new rating parameter.
